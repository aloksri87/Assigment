...
<%} %>
<form action="authors" method="post" name="authorcreationform" onsubmit="return validate(this)">
 <input type="hidden" name="authorhidden" value="authorcreationform"/>
 <table border="1" cellpadding="5" width="300" align="center">
<tr><td>Author ID</td><td><input type="text" name="aid" onkeypress="return isNumberKey(event);"></td></tr>
